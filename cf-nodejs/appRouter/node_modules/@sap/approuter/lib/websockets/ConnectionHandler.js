...
var jwtRefresh = require('../passport/jwt-refresh');
...
ConnectionHandler.prototype.onOpen = function (incoming, outgoing) {
  ...
  if (this.sessionID) {
    var handleSessionEndFn = handleSessionEnd.bind(this);
