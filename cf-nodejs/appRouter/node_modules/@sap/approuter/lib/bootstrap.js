...
var cfNodeJsLogging = require('cf-nodejs-logging-support');
...
var clientCredentialsTokenMiddleware = require('./middleware/client-credentials-token-middleware');
...
var serviceDestinationsMiddleware = require('./middleware/service-destinations-middleware');
...
module.exports = function bootstrap(options) {
  ...
  var cookies = { secure: routerConfig.secureSessionCookie };
